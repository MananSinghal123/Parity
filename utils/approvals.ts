// Token approval checks and transaction creation for Polymarket trading
...
async function checkUSDCApprovalForSpender(
  safeAddress: string,
  spender: string
): Promise<boolean> {
  try {
...
async function checkERC1155ApprovalForSpender(
  safeAddress: string,
  spender: string
): Promise<boolean> {
  try {
...
export async function checkAllApprovals(safeAddress: string): Promise<{
  allApproved: boolean;
